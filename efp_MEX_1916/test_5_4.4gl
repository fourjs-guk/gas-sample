...
MAIN 
  ...
  --validación que NO se tenga Preliquidación de Dispersión de Pagos ejecutándose
    ...
    OPEN WINDOW v_consulta WITH FORM "DISC111_1"

    LET fl_seguir=FALSE
    
    INPUT BY NAME f_folio,v_cmb_tipo_monto ATTRIBUTES (ACCEPT = FALSE , CANCEL = FALSE )
            BEFORE INPUT
    ...
    IF fl_seguir=FALSE THEN
       EXIT PROGRAM
    END IF
    
    OPEN WINDOW v_consulta WITH FORM "DISC111_1"

    DISPLAY BY NAME f_folio,v_cmb_tipo_monto
